...
def evaluate_comments_and_append(
    ...
    for index, (target, prediction) in enumerate(comments):
        user_message = (
            f"You are a reviewer analyzing two code review comments.\n"
            f"Your task is to determine whether both comments are pointing to the same issue.\n\n"
            f"Reviewer 1: {target}\n"
            f"Reviewer 2: {prediction}\n\n"
            f"Focus on the meaning and intent of the comments.\n"
