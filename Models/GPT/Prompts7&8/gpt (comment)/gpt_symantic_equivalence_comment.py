...
def evaluate_comments_and_append(
    ...
    for index, (target, prediction) in enumerate(comments):
        user_message = (
            f"In the context of a code review, two reviewers have made the following comments:\n"
            f"Reviewer 1: {target}\n"
            f"Reviewer 2: {prediction}\n\n"
            f"Do these comments point to the same issue? Focus on the meaning and intent of the comments. "
